...
const renderTrackMessage = (track) => {
    switch (track) {
        ...
        case 'Mobile_Development':
          return 'Based on your responses, you exhibit a keen eye for details, a high level of ethical responsibility, resilience, curiosity, research orientation, and technical aptitude for solving complex problems. Mobile development thrives on these qualities. Your openness to unconventional ideas suggests you might enjoy exploring cutting-edge technologies to tackle complex challenges. Your aptitude for creative problem-solving aligns well with roles where you will design intuitive user interfaces, debug issues, and optimize performance. Your ability to collaborate and communicate effectively will be invaluable in the dynamic field of mobile development.';
        case 'Data_Science_and_AI':
        ...
        case 'Mixed_Realities_and_3D_Animation':

...
function Quiz() {
    ...
    const handleResponse = (answerID, scores) => {
        if (selectedAnswer === answerID) {
            setSelectedAnswer(null);
            setTrackScores(prevScores => {
                const updatedScores = { ...prevScores };
                Object.keys(scores).forEach(track => {
                    updatedScores[track] -= scores[track]; // Subtract scores
                });
            ...
            setTrackScores(prevScores => {
                const updatedScores = { ...prevScores };
                Object.keys(scores).forEach(track => {
                    updatedScores[track] += scores[track]; // Add scores
                });    
                return updatedScores;
            });
        }
      ...
      {currentQuestion < questions.length  ? (
            <div className="quiz-box">
                ...
                <div className="question-answers">
                    ...
                    <div id='answers'>
                        <ul>
                            {questions[currentQuestion].answers.map(({ answerID, answerText, scores, uncheckedSVG, checkedSVG }) => (
                                <li key={answerID}>
                                    {/* <span>{answerID}</span> */}
                                    {/* {uncheckedSVG} */}
                                    <div onClick={() => handleResponse(answerID, scores)}>
                                        {
